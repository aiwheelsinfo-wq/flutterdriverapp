  ...
  Future<void> _updateBookingStatus() async {
    ...
    try {
      ...
      if (tripType == 'One-way') {
        ...
        double preTax = totalAmountDB! / 1.05;

        double gst = totalAmountDB! - preTax;

        double commission = preTax * 0.10;

        finalVendorAmount = (preTax - commission) + parking + toll + permit;

        finalAgniAmount = commission + gst;
        ...
        double commVal = totalBeforGst * 0.05;
        if (driverRate != null && driverRate! > 0) {
          ...
          finalVendorAmount = (totalBeforGst - commVal) +
              exKmChargeDr +
              exHrsChargeDr +
              toll +
              parking +
